  ...
  def set_node(xml, [head | tail], new_value, index) do
    ...
    cond do
      data[head] != nil && data[head] != [] -> # This case is used
        ...
        cond do
          node[head] == nil || (data == node && node[head] != nil) -> set_node(xml, [head | tail], new_value, index+1) # This case is used
      ...
      # data != nil && data[head] != nil && index<length(data[head]) -> set_node(xml, [head | tail], new_value, index+1) #It seems that never execute this case.
